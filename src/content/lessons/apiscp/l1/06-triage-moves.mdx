...
<AnnotatedScreenshot
  ...
  caption="Three UIDs share the account: the account user (admin and any secondary users), the web user (apache, the PHP-FPM process), and root for system files. The warning slice is what Fortification creates; details in the Advanced course."
>
