...
>
  ...
  <Hotspot client:load x={5} y={30} label="1" title="Globe icon" purpose="Indicates you're at MSP layer, not inside a single sub-org.">
    Settings made under the globe affect Global Policies and Global Universal Lists. Clicking a sub-org swaps the icon.
  </Hotspot>
  <Hotspot client:load x={5} y={71} label="2" title="Add Organization" purpose="Self-serve sub-org creation.">
