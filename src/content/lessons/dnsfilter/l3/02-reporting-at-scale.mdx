...
>
  <Hotspot client:load x={6} y={45} label="1" title="Reporting nav entry" purpose="Pattern-match the surface, don't memorise tabs.">
  ...
  <Hotspot client:load x={50} y={15} label="2" title="Filter drawer" purpose="Narrow by date, status, sub-org, user, or site.">
    Customer-facing reports start here. Filter to the sub-org and date window before grouping.
  </Hotspot>
  <Hotspot client:load x={75} y={15} label="3" title="Group-by selector" purpose="Different groupings answer different questions.">
