...
<DecisionTree
  ...
  description="WHOIS shows the domain example.com registered at GoDaddy with nameservers ns1.cloudflare.com and ns2.cloudflare.com. `dig A example.com` returns 198.51.100.42. You ping the IP and get nothing. The client says the website is down."
  nodes={[
    {
      type: "question",
      id: "root",
