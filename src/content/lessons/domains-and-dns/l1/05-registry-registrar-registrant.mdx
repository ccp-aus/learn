...
<DecisionTree
  ...
  description="A client emails: 'we need to transfer our domain example.com to a new registrar. Please get the auth code.' Your documentation system says the domain is registered with FastHostsCo, your usual supplier. WHOIS reports the registrar as Tucows Domains Inc."
  nodes={[
    {
      type: "question",
      id: "root",
