...
<DecisionTree
  ...
  description="A small-business client emails: 'I'm starting to get harassed in the comments on my website. The harasser keeps mentioning my home address; they must have looked it up in WHOIS. Can you turn on domain privacy to fix this?'"
  nodes={[
    {
      type: "question",
      id: "root",
