...
<DecisionTree
  ...
  description="A client emails: 'we want to move example.com to Cloudflare Registrar. The Cloudflare side is asking for the auth code.' You look at WHOIS. The domain shows `clientTransferProhibited` and was registered four months ago at the current registrar."
  nodes={[
    {
      type: "question",
      id: "root",
