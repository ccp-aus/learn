...
<DecisionTree
  ...
  description="You change a client's A record from 203.0.113.10 to 198.51.100.42 at Cloudflare DNS. Thirty minutes later the client emails: 'the website still shows the old server.' Where is the old IP coming from?"
  nodes={[
    {
      type: "question",
      id: "root",
