...
The Beginner course covered why the registrar and the DNS host are different things. The Intermediate course starts with the operational consequence: the first thing you do on any DNS ticket is identify which is which, and the first thing you do on any onboarding is decide whether you're keeping DNS where it is or moving it.
...
<Checkpoint slug="domains-and-dns-l2-checkpoint-registrar-host" client:visible />
