...
<DecisionTree
  ...
  description="A new client onboards. Their domain is managed at a DNS host the previous MSP set up; you have no panel access. The client asks: 'can you give us a list of all our current DNS records so we know what we have?'"
  nodes={[
    {
      type: "question",
      id: "root",
