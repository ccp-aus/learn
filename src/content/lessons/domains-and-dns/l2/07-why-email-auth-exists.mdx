...
<DecisionTree
  ...
  description="A client emails: 'our customers say emails from us are landing in their spam folder. Can you fix this?' You pull the zone and see no SPF, no DKIM CNAMEs, no DMARC record."
  nodes={[
    {
      type: "question",
      id: "root",
