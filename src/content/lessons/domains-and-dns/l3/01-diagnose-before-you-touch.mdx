...
The web designer initially planned a one-line ticket. The five-question pattern caught a request that would have replaced production with an unfinished server. Pushing back well is part of the L3 job.

<Checkpoint slug="domains-and-dns-l3-checkpoint-cutover" client:visible />
