...
<DecisionTree
  ...
  description="A client wants to move DNS from GoDaddy (their current registrar's default DNS) to Cloudflare DNS. The website and mail are working. 'Minimal downtime' is the requested outcome."
  nodes={[
    {
      type: "question",
      id: "root",
