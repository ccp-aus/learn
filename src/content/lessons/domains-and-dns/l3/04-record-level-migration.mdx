...
A client is migrating their website to a new web host. The new host gave them `198.51.100.42`. Current A record at the apex points at the old host with TTL 86400. Minimal user-visible downtime is the goal.
