...
<DecisionTree
  ...
  description="A client emails: 'the previous MSP set up DNSSEC on our domain example.com. We don't need it. Please disable it and move our DNS to Cloudflare in the same change so we can use their analytics.'"
  nodes={[
    {
      type: "question",
      id: "root",
