...
<StepThrough client:load>
  ...
  <Step title="Configure mail flow for everyone">
    ...
    {/* TODO: capture screenshot of the Test Group switch and 'Send all email to Exclaimer' panel */}
  </Step>
  <Step title="User Details Editor for self-serve fields">
    ...
    {/* TODO: capture screenshot of Sender Management → User Details Editor field-visibility settings */}
  </Step>
</StepThrough>
