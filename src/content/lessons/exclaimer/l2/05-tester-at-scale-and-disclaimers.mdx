...
<StepThrough client:load>
  <Step title="Branded regulatory disclosure">
    ...
    {/* TODO: capture screenshot of the Brand Kit Disclaimer asset editor */}
  </Step>
  <Step title="Plain-text confidentiality footer for everyone external">
    ...
    {/* TODO: capture screenshot of the Disclaimers list screen with the Create button */}
  </Step>
