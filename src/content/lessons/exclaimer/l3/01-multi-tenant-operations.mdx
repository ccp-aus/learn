...
<AnnotatedScreenshot src="/img/exclaimer/menu-initials.png" alt="The Exclaimer portal header bar with Signature Search, a help question mark, a Settings cogwheel, and the user's initials 'AF' badge in the top-right corner, highlighted with a red box" caption="The initials badge (top-right of every page) is the only path to Change Subscription. If the header doesn't read the customer's name once the new subscription opens, you're still in the wrong tenant." />
...
<Checkpoint slug="exclaimer-multi-tenant-ops-checkpoint-tenancy" client:load />
