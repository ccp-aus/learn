...
<StepThrough client:load>
  <Step title="Open Engagement, last 30 days, External only">
    ...
    {/* TODO: capture screenshot of the Engagement dashboard with date range and per-signature breakdown */}
  </Step>
  ...
  <Step title="Open Feedback if Feedback elements are deployed">
    ...
    {/* TODO: capture screenshot of the Feedback Reporting tab showing the donut charts and Leaderboard */}
  </Step>
